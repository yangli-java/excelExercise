 ...
 */
public class FormCustomDateEditor extends PropertyEditorSupport {
	 ...
	 */
	public FormCustomDateEditor(DateFormat dateFormat, boolean allowEmpty) {
	 ...
	 */
	public FormCustomDateEditor(DateFormat dateFormat, boolean allowEmpty, int exactDateLength) {
		this.dateFormat = dateFormat;
		this.allowEmpty = allowEmpty;
	...
	public void setAsText(String text) throws IllegalArgumentException {
		if (this.allowEmpty && !StringUtils.hasText(text)) {
			...
			try {
				text = text.replace("Z", " UTC");//注意是空格+UTC
